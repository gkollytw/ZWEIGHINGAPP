sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.ms.pp.Weighing.controller.SaisieAutreComposant", {
		...
		_onContinuerPress: function(oEvent) {
			...
			//oComponent.mCurrentItem = oComponent.mCurrentItem + 1;
			...
			if (newBindingContext !== null){
				...
				this.doNavigate("PeseeAutreOf", newBindingContext, "", "");
			}
		...
		_onTerminerPeseePress: function(oEvent) {
			...
			return new Promise(function(fnResolve) {
				...
				this.doNavigate("PeseeAutreOf", oBindingContext, fnResolve, "");
		...
		onInit: function() {
			...
			this.oRouter.getTarget("SaisieAutreComposant").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
