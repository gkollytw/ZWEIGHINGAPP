sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.ms.pp.Weighing.controller.FinHuComposant", {
		...
		_onButtonYesPress: function (oEvent) {

			var oComponent = this.getOwnerComponent();
			var newBindingContext = oComponent.moveToNextItem();
			if (newBindingContext !== null) {
				this.doNavigate("SaisieBacPrelevement", newBindingContext, "", "");
			} else {
				this.doNavigate("ListeOf", newBindingContext, "", "");
			}
		},
		_onDetruireComposantPress: function (oEvent) {

			var oBindingContext = this.getView().getBindingContext("orderComponentModel");
			this.doNavigate("DestructionComposant", oBindingContext, "", "");

		},
		_onButtonNoPress: function (oEvent) {
		...
		onInit: function () {
			...
			this.oRouter.getTarget("FinHuComposant").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
